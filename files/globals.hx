...
extern int *seeds_h, *seeds_dev; 	// seeds will have size nFish (each thread will get unique seed) 
...
extern float2 * pos_dev_next, * vel_dev_next;
extern float  * Rs_dev;
...
// population
extern int nFish;	// number of fish 
extern int blockSize;	// number of blocks
