...
# > GPU_CONFIG
# population
particles 		65536			# total number of particles 4096, 16384, 65536, 262144, 1048576
...
arenaSize 		2400				# the size of the entire space (x & y), when body size = 1 --# > determines density
